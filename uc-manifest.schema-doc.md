...
#### <a name="settings_environmentVariables_items"></a>9.1.1. Manifest file structure > settings > environmentVariables > environmentVariables items
...
###### <a name="settings_environmentVariables_items_select_items"></a>9.1.1.8.1. Manifest file structure > settings > environmentVariables > environmentVariables items > select > select items
...
### <a name="features_items"></a>11.1. Manifest file structure > features > features items
...
### <a name="platform_items"></a>12.1. Manifest file structure > platform > platform items
...
----------------------------------------------------------------------------------------------------------------------------
Generated using [json-schema-for-humans](https://github.com/coveooss/json-schema-for-humans) on 2025-03-11 at 07:13:57 +0100
